    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="border-b border-slate-800/60 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="https://zulqurnainj.com/saas" className="text-xs text-slate-500 hover:text-slate-300 transition-colors hidden sm:block">More Tools</a>
      ...
      <footer className="border-t border-slate-800/60 bg-slate-900/30">
        <div className="max-w-5xl mx-auto px-4 py-6 text-center">
          ...
          <p className="text-xs text-slate-700">Built by <a href="https://zulqurnainj.com" className="text-slate-500 hover:text-slate-300 transition-colors">Zulqurnain Haider</a> · Open source on <a href="https://github.com/Zulqurnain/prompt-health-checker" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-slate-300 transition-colors">GitHub</a></p>
        </div>
      </footer>
    </div>
  );
