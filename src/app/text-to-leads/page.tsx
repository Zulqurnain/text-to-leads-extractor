...
export default function TextToLeadsPage() {
  return (
      ...
      <div className="max-w-xl w-full flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-olive-600 text-lg leading-relaxed">
            Paste any job post, LinkedIn message, or outreach text. AI extracts
            recruiter emails, WhatsApp numbers and Telegram handles — then
            generates a personalised message with your CV attached, sent in one
            click.
          </p>
        </div>
        ...
        <ul className="flex flex-col gap-2">
          {[
            ...
            "Upload your CV once — reused for every outreach",
          ].map((f) => (
