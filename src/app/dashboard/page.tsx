          ...
          {!connection && (
            <div className="flex gap-2">
              <a href="/api/auth/gmail/start"
                className="flex-1 text-sm text-center px-3 py-2 rounded-lg bg-olive-800 text-olive-100 hover:opacity-80 transition-opacity">
                Connect Gmail
              </a>
              <a href="/api/auth/outlook/start"
                className="flex-1 text-sm text-center px-3 py-2 rounded-lg bg-olive-200 text-olive-800 hover:opacity-80 transition-opacity">
                Connect Outlook
              </a>
            </div>
          )}
        ...
        {result && (
          <div className="flex flex-col gap-4">
            ...
            {result.extracted.phones.length > 0 && (
              <div className="bg-white rounded-xl p-4 shadow-sm flex flex-col gap-2">
                <p className="text-xs font-semibold uppercase tracking-wider text-olive-400">WhatsApp numbers</p>
